...
public:
    ...
    string activeVertexColor2 = "f08102";
    string inactiveVertexColor = "f7b267";
    string backgroundColor =     "FEFEF6";
    string textColor =           "111116";
    string activeEdgeColor2 =     "f00202";
    string activeEdgeColor3 =     "02f006";
    string activeEdgeColor4 =      "2100f5";
    string activeEdgeColor5 =       "4334eb";
    ...
    explicit GraphPrinter(string filename, string documentType = "standalone")
        ...
        defineColor(activeEdgeColor2);
        defineColor(activeEdgeColor3);
        defineColor(activeVertexColor2);
        defineColor(activeEdgeColor4);
        defineColor(activeEdgeColor5);
    }
